...
import { fetchMarketplace, fetchItemListings, fetchItemTraders, fetchDollarItems } from './weav3r.js?v=21';
import { fetchItemMarketLow } from './torn.js?v=21';
import {
  prescreenBreakdown, pickBuyer, buildFlipRows, buildDollarRows, rejectionReason,
  sortByTotalProfit, allocateBudget,
} from './profit.js?v=21';
import { withNormal } from './normal.js?v=21';
